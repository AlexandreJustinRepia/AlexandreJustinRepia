...
- ⚙️ Stronger in **back-end development** (Laravel, PHP, MySQL, REST APIs).  
- 🎨 Learning and improving my **front-end skills** (Vue, React, Tailwind CSS).  
- 🛠️ I enjoy working on projects that combine functionality with real-world impact.  
...
---
[![](https://visitcount.itsvg.in/api?id=AlexandreJustinRepia&icon=6&color=0)](https://visitcount.itsvg.in)
